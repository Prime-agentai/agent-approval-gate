...
Run the suite. All seven files, all 254 cases, no arguments, no test runner:

```bash
python3 tests/test_gate_guard.py    # 49 cases, rule-pack behavior
...
python3 tests/test_verify.py        # 45 cases, incl. mutation tests on verify.py
